#ifndef SIXTRACKLIB_XSIMD_PARTICLES_TRACK_PARTICLE_BASE_CXX_HPP__
#define SIXTRACKLIB_XSIMD_PARTICLES_TRACK_PARTICLE_BASE_CXX_HPP__
...
#endif /* SIXTRACKLIB_XSIMD_PARTICLES_TRACK_PARTICLE_BASE_CXX_HPP__ */

/* end: cxx/xsimd/track_particle_base.hpp */
